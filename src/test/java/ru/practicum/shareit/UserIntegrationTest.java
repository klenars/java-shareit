...
public class UserIntegrationTest {
    ...
    @Test
    public void shouldThrowExceptionWithWrongEmail() {
        userDto.setEmail("user.mail.ru");

        FieldValidationException exception = Assertions.assertThrows(
                FieldValidationException.class, () -> userService.create(userDto)
        );
        assertThat(exception.getMessage(), equalTo("Email is wrong!"));
    }
}
