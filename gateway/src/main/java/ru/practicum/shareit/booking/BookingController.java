...
public class BookingController {
	...
	public ResponseEntity<Object> bookItem(
		...
		checkDateStartAndEnd(requestDto);
	...
	private void checkDateStartAndEnd(BookItemRequestDto bookingRequestDto) {
		if (bookingRequestDto.getEnd().isBefore(bookingRequestDto.getStart())) {
			throw new FieldValidationException("End booking can't be earlier than start!");
		}
	}
}
